...
public class DashboardController implements Initializable, ThemeAware {

    private static final String CSS_DARK = "/ressources-wejden/style.css";
    private static final String CSS_LIGHT = "/ressources-wejden/style-light.css";

    @FXML private BorderPane moduleRoot;
    ...
    private void applyLocalStylesheets() {
        ...
        moduleRoot.getStylesheets().clear();
        String path = isDarkTheme ? CSS_DARK : CSS_LIGHT;
        URL u = getClass().getResource(path);
        if (u != null) {
            moduleRoot.getStylesheets().add(u.toExternalForm());
        }
    }
    ...
    private void handleLogout() {
        ...
        al.setContentText("Deconnexion : utilisez le menu principal 7anouti-E (profil ou bouton deconnexion).");
        al.showAndWait();
    }
