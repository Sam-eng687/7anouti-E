    ...
    public static void sendVendeurEmail(String toEmail, String nomVendeur,
        ...
        jakarta.mail.Session session = jakarta.mail.Session.getInstance(props, new jakarta.mail.Authenticator() {
            ...
            protected jakarta.mail.PasswordAuthentication getPasswordAuthentication() {
                return new jakarta.mail.PasswordAuthentication(MY_EMAIL, MY_PASSWORD);
            }
        });

        try {
            jakarta.mail.Message message = new jakarta.mail.internet.MimeMessage(session);
            message.setFrom(new jakarta.mail.internet.InternetAddress(MY_EMAIL));
            // Toujours envoyer à la boîte principale, peu importe le vendeur
            message.setRecipients(jakarta.mail.Message.RecipientType.TO,
                jakarta.mail.internet.InternetAddress.parse(MY_EMAIL));
