...
public class CampagneMarketing {
    ...
    private String statut; // ACTIVE, TERMINEE, BROUILLON
    ...
    public CampagneMarketing(String nomCampagne, String objectif, String canal,
                              double budget, double depense, String statut,
                              Date dateDebut, Date dateFin, double iaScore, String iaConseil) {
    ...
    public double getIaScore() { return iaScore; }
    public void setIaScore(double iaScore) { this.iaScore = iaScore; }
    public String getIaConseil() { return iaConseil; }
    public void setIaConseil(String iaConseil) { this.iaConseil = iaConseil; }
}
