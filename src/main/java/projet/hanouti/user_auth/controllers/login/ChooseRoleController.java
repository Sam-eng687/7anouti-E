...
public class ChooseRoleController {
    ...
    public void initialize() {
        ...
        setupRoleCard(acheteurCard, "/FXML/user_auth/login/register_view.fxml");
        setupRoleCard(vendeurCard, "/FXML/user_auth/login/register_vendeur_view.fxml");
        setupRoleCard(livreurCard, "/FXML/user_auth/login/register_livreur_view.fxml");

        backLoginLink.setOnAction(e -> navigate("/FXML/user_auth/login/login_view.fxml"));
