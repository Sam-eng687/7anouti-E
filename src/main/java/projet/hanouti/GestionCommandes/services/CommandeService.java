...
public class CommandeService implements IntService<Commande> {
    ...
    public Commande createFromPanier(int idAcheteur, int idVendeur,
        ...
        // Notification vendeur — visible in notification center
        NotificationService notifService = new NotificationService();
        notifService.envoyerNotification(
                idVendeur,
                TypeNotification.COMMANDE,
                EventNotification.COMMANDE_CONFIRMEE,
                "Nouvelle commande reçue",
                "Une nouvelle commande " + numeroCommande + " a été créée par un acheteur.",
