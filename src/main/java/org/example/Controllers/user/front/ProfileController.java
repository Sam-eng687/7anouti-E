package org.example.Controllers.user.front;
...
import org.example.Utils.FormValidator;
...
public class ProfileController {
    ...
    private void loadUserData() {
        ...
        boolean active = currentUser.getStatus() != null
                && currentUser.getStatus() == org.example.Entites.user.Status.Unbanned;
    ...
    private void navigateToHome() {
        try {
            javafx.fxml.FXMLLoader loader = new javafx.fxml.FXMLLoader(
                    getClass().getResource("/user/front/home_view.fxml"));
    ...
    private void addStylesheets(javafx.scene.Scene scene) {
        java.net.URL f = getClass().getResource("/user/front/front.css");
        if (f != null) scene.getStylesheets().add(f.toExternalForm());
        java.net.URL l = getClass().getResource("/user/login/login.css");
