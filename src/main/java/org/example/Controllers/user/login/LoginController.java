...
public class LoginController {
    ...
    public void initialize() {
        ...
        if (themeToggleBtn != null) {
            ...
            themeToggleBtn.selectedProperty().addListener((obs, old, selected) -> {
                setDarkMode(selected);
                bounceNode(themeToggleBtn, 0.90);
            });
        }
    ...
    private void navigateToDashboard(User connectedUser) {
        try {
            java.net.URL fxml = getClass().getResource("/user/back/dashboard.fxml");

            if (fxml == null) {
                showError("FXML dashboard introuvable: /user/back/dashboard.fxml");
                return;
            }
            ...
            org.example.Controllers.user.back.DashboardController dashCtrl = loader.getController();
            dashCtrl.setConnectedAdmin(connectedUser);

            javafx.scene.Scene scene = rootPane.getScene();
            scene.getStylesheets().clear();

            java.net.URL css = getClass().getResource("/user/back/dashboard.css");
            if (css != null) {
    ...
    private void navigateToAcheteur(User connectedUser) {
        navigateToRoleFront("/user/front/home_view.fxml");
    }

    private void navigateToVendeur(User connectedUser) {
        navigateToRoleFront("/user/front/home_vendeur_view.fxml");
    }

    private void navigateToLivreur(User connectedUser) {
        navigateToRoleFront("/user/front/home_livreur_view.fxml");
    }
    ...
    private void navigateToRoleFront(String fxmlPath) {
        try {
            ...
            java.net.URL frontCss = getClass().getResource("/user/front/front.css");
            if (frontCss != null) {
                scene.getStylesheets().add(frontCss.toExternalForm());
            }

            java.net.URL loginCss = getClass().getResource("/user/login/login.css");
            if (loginCss != null) {
    ...
    private void navigateToRegister() {
        try {
            javafx.fxml.FXMLLoader loader = new javafx.fxml.FXMLLoader(
                    getClass().getResource("/user/login/choose_role_view.fxml")
            );
    ...
    private void navigateToForgotPassword() {
        try {
            javafx.fxml.FXMLLoader loader = new javafx.fxml.FXMLLoader(
                    getClass().getResource("/user/login/forgot_password_view.fxml")
            );
    ...
    private void onFaceLogin() {
        ...
        new Thread(() -> {
            try {
                ...
                boolean match = org.example.Utils.FaceRecognition.recognize(
                        newCapture,
    ...
    private void navigateToMainDashboard() {
        try {
            java.net.URL fxmlUrl = getClass().getResource("/user/back/main_dashboard.fxml");

            if (fxmlUrl == null) {
                showError("main_dashboard.fxml introuvable dans /user/back/");
                return;
            }
            ...
            java.net.URL css = getClass().getResource("/user/back/main_dashboard.css");
            if (css != null) {
                scene.getStylesheets().add(css.toExternalForm());
            }
